  ...
  const pieData = [
    {
      id: "used",
      label: "Used",
      value: 75, // Replace with actual data
      color,
    },
    {
      id: "remaining",
      ...
      <CardContent className="p-4">
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex flex-col gap-4 lg:w-1/2">
            <h4 className="text-sm font-medium text-slate-600">Current Reality</h4>
          ...
          <div className="flex flex-col gap-4 lg:w-1/2">
            <h4 className="text-sm font-medium text-slate-600">Goals</h4>
            <ul className="space-y-2">
